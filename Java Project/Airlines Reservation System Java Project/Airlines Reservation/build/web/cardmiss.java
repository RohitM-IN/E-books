...
public class cardmiss extends HttpServlet
{
				...
				throws ServletException,IOException
	{
		...
		out.println("<html><head><title>Missed Card Details</title>");
		...
		out.println("<form name='form1'  action='http://localhost:8080/servlet/cardmiss1'>");
		out.println("<div align='center'>");
		out.println("<br>");
		out.println("<p><font size='6' color='black'><b>Missed Card Details</font>");
