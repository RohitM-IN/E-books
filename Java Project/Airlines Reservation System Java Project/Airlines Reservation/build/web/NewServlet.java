...
out.println("{");
out.println("var name,pass,i,addr,email,resphone,offphone,income,at=0,dot=0");
out.println("name=document.newform.cname.value");
out.println("pass=document.newform.pass.value");
out.println("addr=document.newform.addr.value");
out.println("email=document.newform.email.value");
out.println("income=document.newform.income.value");
...
out.println("}");
out.println("if(repass==0){");
out.println("alert('PLEASE CONFIRM YOUR PASSWORD')");
out.println("}");
...
out.println("<body bgcolor=silver>");
		...
		out.println("<TD bgColor=silver><FONT face=Arial color=blue size=4><B>Applicant's Personal Details :</B></FONT>");
		out.println("</TD></TR></font></TBODY></TABLE>");
		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0><TBODY>");
		out.println("<TR>");
		...
		out.println("<input type='radio' maxLength=25  name='cma' value='m'>MALE<INPUT TYPE='RADIO' MAXLENGTH=25 NAME='cma' VALUE='f'>FEMALE<BR></FONT>");
		out.println("</TD></TBODY></table>");
		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0><TBODY>");
		out.println("<TR bgColor=silver><TD bgColor=silver><FONT face=Arial color=blue size=2><B>Applicant's Mailing Address :</B></FONT>"); 
		...
		out.println("</TD></TR>");
		out.println("<TR bgColor=silver><TD width='25%' height=2><FONT face=Arial size=2><input type=textbox name='add' size='20'></FONT> </TD>");
		out.println("<TD width='25%' height=2><FONT face=Arial size=2><INPUT type=textbox name='pin' size='6'></FONT> </TD>");
		...
		out.println("</TD></TR></TBODY></TABLE>");
		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0>");
		out.println("<TBODY>");
		out.println("<TR bgColor=silver><TD width='25%' height=4><FONT face=Arial size=2>E-Mail Address</FONT></TD>");          
		out.println("<TD height=4><FONT face=Arial size=1>&nbsp;</FONT><FONT face=Arial size=1></FONT> </TD></TR>");
		out.println("<TR bgColor=silver><TD width='25%' height=2><FONT face=Arial size=2><INPUT type=textbox name='email' size='20'></FONT> </TD>");
		out.println("<TD vAlign=top height=2><FONT face=Arial size=2>&nbsp;</FONT>"); 
		out.println("</TD></TR></TBODY></TABLE>");
		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0><TBODY>");
		out.println("<TR bgColor=silver>");
		out.println("<TD bgColor=silver><FONT face=Arial color=blue size=2><B>Applicant's Telephone :</B></FONT>");
		out.println("</TD></TR></TBODY></TABLE>");
		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0><TBODY>");
		out.println("<TR bgColor=silver>");
		...
		out.println("<OPTION value=Lawyer>Lawyer</OPTION>"); 
  		...
  		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0><TBODY>");
		out.println("<TR bgColor=silver>");
		out.println("<TD bgColor=silver><FONT face=Arial color=blue size=2><B>Applicant's income Details :</B></FONT> ");
		out.println("</TD></TR></TBODY></TABLE>");
		out.println("<TABLE cellSpacing=0 cellPadding=0 width='100%' bgColor=silver border=0><TBODY>");
		out.println("<TR bgColor=silver>");
